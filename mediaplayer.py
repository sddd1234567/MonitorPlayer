...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def dropEvent(self, e):
        for url in e.mimeData().urls():
            ...
            self.video.setMedia(QMediaContent(url))
    ...
    def open_file(self):
        ...
        if path:
            ...
            self.video.setMedia(QMediaContent(QUrl.fromLocalFile(path)))
            self.video.play()
